        ...
        <div class="pt-8 pb-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="dark:bg-gradient-to-r dark:from-black dark:via-gray-900 dark:to-black bg-gradient-to-r from-white via-gray-50 to-gray-100 border-2 dark:border-yellow-500 border-teal-600 px-6 py-4 rounded-xl shadow-xl transition-all duration-300">
                    ...
                    <p class="dark:text-white text-gray-600 text-sm mt-1">Bem-vindo, {{ Auth::user()->name }}! Gerencie seus agendamentos aqui.</p>
                </div>
            </div>
        </div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="dark:bg-gradient-to-br dark:from-gray-900 dark:to-black bg-gradient-to-br from-white to-gray-100 border-2 dark:border-yellow-500 border-emerald-600 rounded-2xl p-6 hover:shadow-2xl dark:hover:border-yellow-400 hover:border-emerald-500 transition-all duration-300 transform hover:scale-105">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="dark:text-yellow-400 text-emerald-700 text-sm font-medium uppercase tracking-wider">Próximos</p>
                            <p class="dark:text-white text-gray-800 text-3xl font-bold mt-2">{{ $upcomingAppointments->count() }}</p>
                        </div>
                        <div class="dark:bg-gradient-to-r dark:from-yellow-500 dark:to-yellow-600 bg-gradient-to-r from-emerald-600 to-emerald-700 p-3 rounded-full shadow-lg">
                            <i class="fas fa-calendar-plus dark:text-black text-white text-xl"></i>
                        </div>
                    </div>
                </div>

                <!-- Histórico -->
                <div class="dark:bg-gradient-to-br dark:from-gray-900 dark:to-black bg-gradient-to-br from-white to-gray-100 border-2 dark:border-orange-400 border-teal-600 rounded-2xl p-6 hover:shadow-2xl dark:hover:border-orange-300 hover:border-teal-700 transition-all duration-300 transform hover:scale-105">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="dark:text-orange-400 text-teal-700 text-sm font-medium uppercase tracking-wider">Histórico</p>
                            <p class="dark:text-white text-gray-800 text-3xl font-bold mt-2">{{ $appointmentHistory->count() }}</p>
                        </div>
                        <div class="dark:bg-gradient-to-r dark:from-orange-400 dark:to-orange-500 bg-gradient-to-r from-teal-600 to-teal-700 p-3 rounded-full shadow-lg">
                ...
                <!-- Novo Agendamento -->
                <div class="dark:bg-gradient-to-br dark:from-gray-900 dark:to-black bg-gradient-to-br from-white to-gray-100 border-2 dark:border-amber-500 border-orange-600 rounded-2xl p-6 hover:shadow-2xl dark:hover:border-amber-400 hover:border-orange-700 transition-all duration-300 transform hover:scale-105">
                    <div class="text-center">
                        <div class="dark:bg-gradient-to-r dark:from-amber-500 dark:to-amber-600 bg-gradient-to-r from-orange-600 to-orange-700 p-3 rounded-full inline-block mb-3 shadow-lg">
                            <i class="fas fa-plus dark:text-black text-white text-xl"></i>
                        </div>
                        <a href="{{ route('client.appointments.create') }}"
                            class="block w-full dark:bg-gradient-to-r dark:from-yellow-500 dark:to-yellow-600 dark:hover:from-yellow-600 dark:hover:to-yellow-700 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 dark:text-black text-white font-bold py-2 px-4 rounded-lg transition-all duration-200 shadow-lg">
                            Novo Agendamento
                        </a>
                    </div>
                </div>
                                ...
                                @foreach($upcomingAppointments as $appointment)
                                    <div class="dark:bg-gradient-to-r dark:from-gray-700 dark:to-slate-700 bg-gradient-to-r from-slate-100 to-gray-200 border dark:border-gray-600 border-slate-300 rounded-xl p-4 dark:hover:border-amber-400 hover:border-emerald-500 hover:shadow-lg transition-all duration-200">
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <span class="dark:text-yellow-400 text-emerald-700 font-bold">R$ {{ number_format($appointment->price, 2, ',', '.') }}</span>
                                        </div>
                                        <div class="dark:text-gray-300 text-slate-600 text-sm space-y-1">
                                            ...
                                            <p><i class="fas fa-calendar mr-2 dark:text-orange-400 text-slate-600"></i>{{ $appointment->scheduled_at->format('d/m/Y') }}</p>
                                            <p><i class="fas fa-clock mr-2 dark:text-amber-400 text-emerald-600"></i>{{ $appointment->scheduled_at->format('H:i') }}</p>
                                        </div>
            ...
            <!-- Histórico -->
            <div class="dark:bg-gradient-to-br dark:from-gray-900 dark:to-black bg-gradient-to-br from-white to-gray-100 border-2 dark:border-orange-400 border-emerald-600 rounded-2xl overflow-hidden shadow-xl transition-all duration-300">
                <div class="px-6 py-4 dark:bg-gradient-to-r dark:from-orange-500 dark:to-orange-600 bg-gradient-to-r from-emerald-600 to-emerald-700 border-b dark:border-orange-400/30 border-emerald-500/30">
                            ...
                            @foreach($appointmentHistory as $appointment)
                                <div class="dark:bg-gradient-to-r dark:from-gray-700 dark:to-slate-700 bg-gradient-to-r from-slate-100 to-gray-200 border dark:border-gray-600 border-slate-300 rounded-xl p-4 hover:shadow-md transition-all duration-200">
                                    ...
                                    <div class="dark:text-gray-400 text-slate-600 text-sm space-y-1">
                                        <p><i class="fas fa-cut mr-2 dark:text-orange-400 text-teal-600"></i>{{ $appointment->barber->user->name }}</p>
                                        <p><i class="fas fa-calendar mr-2 dark:text-amber-400 text-slate-600"></i>{{ $appointment->scheduled_at->format('d/m/Y H:i') }}</p>
                                    </div>
                                    <div class="mt-2">
                                        <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                                ...
                                                @elseif($appointment->status === 'scheduled') dark:bg-gradient-to-r dark:from-blue-500 dark:to-indigo-600 bg-gradient-to-r from-blue-600 to-indigo-700 text-white
                                                @elseif($appointment->status === 'pending') dark:bg-gradient-to-r dark:from-yellow-500 dark:to-orange-600 bg-gradient-to-r from-yellow-600 to-orange-700 text-white
                                                @elseif($appointment->status === 'in_progress') dark:bg-gradient-to-r dark:from-purple-500 dark:to-pink-600 bg-gradient-to-r from-purple-600 to-pink-700 text-white
                                                ...
                                                @elseif($appointment->status === 'rejected') dark:bg-gradient-to-r dark:from-red-600 dark:to-red-700 bg-gradient-to-r from-red-600 to-red-700 text-white
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <a href="{{ route('client.appointments.index') }}"
                        class="dark:bg-gradient-to-r dark:from-orange-500 dark:to-orange-600 dark:hover:from-orange-600 dark:hover:to-orange-700 bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 dark:text-black text-white font-bold py-3 px-6 rounded-xl text-center transition-all duration-200 shadow-lg transform hover:scale-105">
                        <i class="fas fa-list mr-2"></i>Meus Agendamentos
                    </a>
                    <a href="{{ route('profile.edit') }}"
                        class="dark:bg-gradient-to-r dark:from-amber-600 dark:to-amber-700 dark:hover:from-amber-700 dark:hover:to-amber-800 bg-gradient-to-r from-teal-600 to-emerald-700 hover:from-teal-700 hover:to-emerald-800 dark:text-black text-white font-bold py-3 px-6 rounded-xl text-center transition-all duration-200 shadow-lg transform hover:scale-105">
