<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="dark:bg-gray-800 bg-white rounded-lg shadow-xl p-6 sm:p-8">
                <h2 class="text-2xl font-bold text-teal-700 dark:text-yellow-400 mb-6">
                    <i class="fas fa-plus-circle mr-2"></i>Cadastrar Nova Barbearia
                </h2>

                {{-- IMPORTANTE: enctype é necessário para upload de arquivos --}}
                <form action="{{ route('admin.barbershops.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <fieldset class="border-2 border-gray-300 dark:border-gray-600 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" class="input-form"
                                    required>
                    ...
                    <fieldset class="mt-6 border-2 border-gray-300 dark:border-gray-600 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="city" name="city" value="{{ old('city') }}" class="input-form"
                                    required>
                            ...
                            <div>
                                ...
                                <input type="text" id="state" name="state" value="{{ old('state') }}" class="input-form"
                                    required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-teal-500 focus:border-teal-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">{{ old('description') }}</textarea>
                    ...
                    <fieldset class="mt-6 border-2 border-gray-300 dark:border-gray-600 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-4 gap-3 items-center mt-4">
                            ...
                            <select name="business_hours[{{ strtolower($dia) }}][status]" class="input-form text-sm">
                                <option value="open">Aberto</option>
                                <option value="closed">Fechado</option>
                            </select>
                            <input type="time" name="business_hours[{{ strtolower($dia) }}][open]" class="input-form">
                            <input type="time" name="business_hours[{{ strtolower($dia) }}][close]" class="input-form">
                        </div>
                        @endforeach
                    ...
                    <div class="mt-8 flex justify-end">
                        <button type="submit" class="btn-primary">
                            <i class="fas fa-save mr-2"></i>Salvar Barbearia
                        </button>
                    </div>
                </form>
            </div>
    ...
    {{-- Adicione esta classe CSS genérica no seu app.css para reutilizar --}}
    <style>
        .input-form {
